...
int pivotDeGauss(dmatrice* matrice)
{
    ...
    //L1 and L2
    if(matrice[0].mcol[0].mval > 0 && matrice[1].mcol[0].mval < 0 || (matrice[0].mcol[0].mval < 0 && matrice[1].mcol[0].mval > 0)) 
    {
        multiplyEq(matrice, -1, 1);

    }
    if(matrice[0].mcol[0].mval > matrice[1].mcol[0].mval)
    {
        lcmVal = lcm(matrice[0].mcol[0].mval, matrice[1].mcol[0].mval);
        multiplyEq(matrice, (lcmVal/matrice[1].mcol[0].mval), 1);

        if(lcmVal != matrice[0].mcol[0].mval)
        {
    ...
    else
    {
        ...
        if(lcmVal != matrice[1].mcol[0].mval)
        {
            multiplyEq(matrice, (lcmVal/matrice[1].mcol[0].mval), 1);
    ...
    //L1 and L3
    if(matrice[0].mcol[0].mval > 0 && matrice[2].mcol[0].mval < 0 || (matrice[0].mcol[0].mval < 0 && matrice[2].mcol[0].mval > 0)) 
    {
    ...
    else
    {
        ...
        if(lcmVal != matrice[2].mcol[0].mval)
        {
            multiplyEq(matrice, (lcmVal/matrice[2].mcol[0].mval), 2);
    ...
    if(matrice[1].mcol[1].mval > matrice[2].mcol[1].mval)
        {
            ...
            if(lcmVal != matrice[1].mcol[1].mval)
            {
    ...
    else
    {
        ...
        if(lcmVal != matrice[2].mcol[1].mval)
        {
            multiplyEq(matrice, (lcmVal/matrice[2].mcol[1].mval), 2);
